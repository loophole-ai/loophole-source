...
export VSCODE_CLI_UPDATE_ENDPOINT="https://raw.githubusercontent.com/loophole-ai/versions/refs/heads/master"

if [[ "${VSCODE_QUALITY}" == "insider" ]]; then
  export VSCODE_CLI_DOWNLOAD_ENDPOINT="https://github.com/loophole-ai/loophole-insiders/releases"
else
  export VSCODE_CLI_DOWNLOAD_ENDPOINT="https://github.com/loophole-ai/loophole-ide/releases"
fi
